...
function App() {
  ...
  return (
    ...
    <div className='w-96 h-96 duration-200' style={{backgroundColor: color}}>
      {/* console.log(color); */}
      ...
      <div className="fixed flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-2xl">
        ...
        <button onClick={()=>setColor('crimson')} className='outline-none px-4 py-2 rounded-full text-white shadow-lg' style={{backgroundColor:'crimson'}}>
          crimson
        </button>
        </div>  
      </div>
